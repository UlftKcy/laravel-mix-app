        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <ul class="navbar-nav mr-auto w-100 justify-content-end">
                <li class="nav-item active">
                    <a href="{{route('basket')}}" class="nav-link d-flex align-items-center btn btn-secondary px-3 rounded text-white">Basket<span class="badge bg-warning ms-3" id="product_count_in_basket">{{$total_basket_quantity}}</span></a>
                </li>
                <li class="nav-item active">
